...
and gives actionable feedback. Rule-based analysis — no external APIs or LLM calls required.
...
ats-check path/to/resume.pdf      # installed command
...
- Rule-based (no LLM dependency) — fast, offline, deterministic
